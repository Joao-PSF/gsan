...
| 2026-09-14 | [Compatibilidade das estruturas centrais](2026-09-14-compatibilidade-estruturas-centrais.md) — `compatibilidade/estruturas-centrais.md` criado: **64 decisões** (primária: 37 PRESERVAR · 14 REESTRUTURAR · 6 MODERNIZAR · 5 APROFUNDAMENTO · 2 NÃO TRANSPORTAR) + 6 famílias não transportadas + 16 famílias paramétricas; cada reestruturação responde às 6 perguntas obrigatórias; análises transversais de parametrização, histórico/versão/linhagem/snapshot e identificadores; divergência **D-17 proposta** (não aprovada) | Baixo (documental) |
| 2026-09-15 | [SISAN → OpenGSAN + Visão Conceitual Alvo](2026-09-15-opengsan-e-visao-conceitual.md) — **mudança de identidade** (o sistema passa a chamar-se OpenGSAN, evolução aberta do GSAN) e **de escopo** (migração de instalações GSAN sai do projeto e terá projeto próprio; facilidade de migração deixa de ser critério de desenho). ADRs 0003/0005 reescritas, 0006 calibrada; 31 documentos de estado corrente renomeados; registros históricos preservam SISAN. **`dominio/visao-conceitual-opengsan.md` criado** (31 seções, ownership de 22 conceitos, 30 temas GSAN × OpenGSAN, 12 decisões pendentes) | Baixo (documental) |
| 2026-09-15 | [Catálogo de funcionalidades futuras](2026-09-15-catalogo-funcionalidades-futuras.md) — `modulos/funcionalidades-futuras.md` criado: **26 capacidades** do legado classificadas por natureza (8 core futuro · 7 módulo opcional · 6 integração · 3 extensão de companhia · 2 aprofundamento), **maturidade da evidência** (4 são `APENAS EVIDÊNCIA`) e horizonte; portal de autoatendimento (47 classes) descoberto **sem dono**; fiscal e SPED com schema e **sem comportamento observável**; 6 padrões transversais, 4 candidatos a módulo, 8 especificidades remapeadas, 6 não candidatos. Backlog renumerado; riscos 3/4/7 atualizados e risco 10 criado | Baixo (documental) |
| 2026-09-15 | [Dependências e ordem de implementação](2026-09-15-dependencias-e-ordem-implementacao.md) — `modulos/dependencias-e-ordem-implementacao.md` criado e `modulos/README.md` reescrito: 26 relações de dependência classificadas, **8 ciclos** (um novo: Cadastro ↔ Segurança pelo escopo territorial), fundação mínima (13 itens de dia 1), primeira fatia vertical recomendada e **9 etapas por capacidade** com gates de prova. 🔴 **A ordem financeira anterior estava invertida** — `cobrança → arrecadação → faturamento` passa a `faturamento → recebimento → cobrança`; Segurança vira três blocos (escopo territorial **depende do Cadastro**); auditoria vai para o dia 1; motor de conta individual na Etapa 4 e lote na 7. As 5 decisões "bloqueantes" foram delimitadas — só uma bloqueia o dia 1 | Baixo (documental) |
