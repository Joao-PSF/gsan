...
| [modulos/seguranca.md](modulos/seguranca.md) | Mapa funcional da Segurança (comportamento): filtro central de autorização por URL, união de grupos, permissões especiais nomeadas, abrangência territorial e sua aplicação manual, ciclo do usuário, auditoria em dois níveis, batch/APIs fora do RBAC de tela |
