...
7. **OS encerrada retroalimenta o cadastro** (atualiza situação das ligações) — cadastro e atendimento são acoplados por regra de negócio, não apenas por referência.
